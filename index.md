...
<body>
    <div class="savanna-styles">
            ...
            <div class="avatar-callout-right">
                ...
                <div class="avatar-text">
                    <p>"Lorem ipsum dolor sit amet. At delectus perspiciatis et odit omnis eum minus impedit.<br><br>
                        In magni mollitia et facere vitae eum alias saepe eum inventore assumenda id quibusdam
                        deserunt id officia voluptates."</p>
                </div>
            </div>
        ...
        <section class="tabs" id="discovery-a">
            <div class="tablist" role="tablist">
                <div class="tab">
                    ...
                    <label class="tab-label" for="disc-a-tab1" role="tab">Disk Panel 1</label>
                    <div class="tab-panel" id="disc-a-panel1" role="tabpanel">
                        ...
                        <div class="tab-footer">
                            <label class="tab-next" for="disc-a-tab2">Next tab →</label>
                        </div>
                    </div>
                </div>
                <div class="tab">
                    <input type="radio" id="disc-a-tab2" name="disc-tabs-a">
                    <label class="tab-label" for="disc-a-tab2" role="tab">Disk Panel 2</label>
                    <div class="tab-panel" id="disc-a-panel2" role="tabpanel">
                        ...
                        <div class="tab-footer">
                            <label class="tab-next" for="disc-a-tab3">Next tab →</label>
                        </div>
                    </div>
                </div>
                <div class="tab">
                    <input type="radio" id="disc-a-tab3" name="disc-tabs-a">
                    <label class="tab-label" for="disc-a-tab3" role="tab">Disk Panel  3</label>
                    <div class="tab-panel" id="disc-a-panel3" role="tabpanel">
                        ...
                        <div class="tab-footer">
                            <label class="tab-next" for="disc-a-tab1">Back to first →</label>
                        </div>
                    </div>
                </div>
                <div class="tab">
                    <input type="radio" id="disc-a-tab4" name="disc-tabs-a">
                    <label class="tab-label" for="disc-a-tab4" role="tab">Disk Panel 4</label>
        ...
        <section class="tabs" id="discovery-b">
            <div class="tablist" role="tablist">
                <div class="tab">
                    ...
                    <label class="tab-label" for="disc-b-tab1" role="tab">Disk Panel A</label>
                    <div class="tab-panel" id="disc-b-panel1" role="tabpanel">
                        ...
                        <div class="tab-footer">
                            <label class="tab-next" for="disc-b-tab2">Next tab →</label>
                        </div>
                    </div>
                </div>
                <div class="tab">
                    <input type="radio" id="disc-b-tab2" name="disc-tabs-b">
                    <label class="tab-label" for="disc-b-tab2" role="tab">Disk Panel  B</label>
                    <div class="tab-panel" id="disc-b-panel2" role="tabpanel">
                        ...
                        <div class="tab-footer">
                            <label class="tab-next" for="disc-b-tab3">Next tab →</label>
                        </div>
                    </div>
                </div>
                <div class="tab">
                    <input type="radio" id="disc-b-tab3" name="disc-tabs-b">
                    <label class="tab-label" for="disc-b-tab3" role="tab">Disk Panel  C</label>
                    <div class="tab-panel" id="disc-b-panel4" role="tabpanel">
                        ...
                        <div class="tab-footer">
                            <label class="tab-next" for="disc-b-tab1">Back to first →</label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <h3>Images...</h3>
        <figure>
            <img src="https://raw.githubusercontent.com/Explore-AI/Pictures/master/alx-courses/aice/pictures/Tunde_building_wide.png" alt="Tunde standing in front of Magwaza Tech">
        ...
        <h3>Worksheet with copy option</h3>
        ...
        <script src="https://cdn.jsdelivr.net/gh/Explore-AI/Public-Data@refs/heads/workforce-resillience-style-v18/de-alx/wfr-survey-form.js" defer></script>
    </div>
    <br>
    <br>
    <br>
    <div align="center" style=" font-size: 80%; text-align: center; margin: 0 auto"></div>
</body>
</html>
